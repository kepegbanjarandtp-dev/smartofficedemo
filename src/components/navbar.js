...
export function smartofficeRenderMobileNavbar(
  ...
  ========================= */
  /*document
    .getElementById("smartofficeHomeButton")
    ?.addEventListener(
        "click",
  ...
  document
    .getElementById("smartofficeApprovalButton")
    ?.addEventListener(
        "click",
  ...
  document
    .getElementById("smartofficeCutiButton")
    ?.addEventListener(
        "click",
  ...
  document
    .getElementById("smartofficeLogoutButton")
    ?.addEventListener(
        "click",
        smartofficeLogout
    );
